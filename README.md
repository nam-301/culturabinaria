**UPDATE SUMMER 2018**
This repository has been a highly experimental project (spring 2018) aimed at organizing & maintaining a non-code collaborative project (developing educational materials for a digital skills course) using Git tools. It probably hasn't worked as we hoped, but that's the beauty of experimentation :relaxed:
